              ...
              children: [
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.history_edu_rounded, color: Colors.amberAccent, size: 13),
                          const SizedBox(width: 4),
                          Text('ON THIS DAY', style: GoogleFonts.jetBrainsMono(color: Colors.amberAccent, fontSize: 10, fontWeight: FontWeight.w800, letterSpacing: 1)),
                        ],
                      ),
                    ),
                    const Spacer(),
                    if (data.yearsAgo > 0)
                      Container(
                        ...
                        child: Text('${data.yearsAgo} YEARS AGO', style: GoogleFonts.jetBrainsMono(color: Colors.white, fontSize: 10, fontWeight: FontWeight.w700)),
                      ),
                  ],
                ),
                const Spacer(),
                if (data.dateLabel != 'N/A') ...[
                  Text(
                    ...
                    style: GoogleFonts.jetBrainsMono(color: Colors.amberAccent, fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 1.5),
                  ),
                ...
                if (data.subtext.isNotEmpty && data.subtext != 'N/A') ...[
                  ...
                  Text(
                    data.subtext,
                    style: GoogleFonts.inter(color: Colors.white70, fontSize: 13, height: 1.3),
                    maxLines: 3,
                    overflow: TextOverflow.ellipsis,
                  ),
                ],
                const Spacer(),
                Text('Oreamnos Archives', style: GoogleFonts.jetBrainsMono(color: Colors.white.withValues(alpha: 0.6), fontSize: 10)),
              ],
            ),
          ),
        ],
