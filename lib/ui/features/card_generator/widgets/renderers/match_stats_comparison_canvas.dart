...
class MatchStatsComparisonCanvas extends StatelessWidget {
  const MatchStatsComparisonCanvas({
    super.key,
    required this.data,
                    ...
                    child: stats.isNotEmpty
                        ? ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final awayVal =
                                  double.tryParse(
                                    s.awayValue.replaceAll(
                                      RegExp(r'[^0-9.]'),
                                      '',
                                    ),
                                  ) ??
                                  50.0;
                              final total = homeVal + awayVal > 0
                                  ? homeVal + awayVal
                                  : 100.0;
                              final homeRatio = (homeVal / total).clamp(
                                0.1,
                                0.9,
                              );
