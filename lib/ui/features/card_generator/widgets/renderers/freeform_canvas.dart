  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: config.backgroundImagePath != null ? null : GradientBuilder.vertical(colors),
      ),
      child: Stack(
        children: [
          if (config.showScrim)
          ...
          if (headline.isNotEmpty)
            _DraggableElement(
              ...
              onOffsetChanged: (o) => notifier.updateElementOffset('headline', o),
          ...
          if (subtext.isNotEmpty)
            _DraggableElement(
              ...
              onOffsetChanged: (o) => notifier.updateElementOffset('subtext', o),
              child: EditableCanvasText(
                subtext,
                fieldKey: 'subtext',
                autoSize: false,
          ...
          if (microStat.isNotEmpty)
            _DraggableElement(
              ...
              onOffsetChanged: (o) => notifier.updateElementOffset('microStat', o),
              child: EditableCanvasText(
                microStat,
                fieldKey: 'microStat',
                autoSize: false,
