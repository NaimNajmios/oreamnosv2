...
@override
int get hashCode => Object.hashAll([runtimeType,brief,cardData,isExtracting,extractionError,selectedTemplate,selectedRatio,selectedFont,headlineScale,templateCompact,activePanel,focusedField,backgroundImage,scrimOpacity,useVignette,useAutoPalette,const DeepCollectionEquality().hash(extractedPalette),const DeepCollectionEquality().hash(rewritingFields),rewriteError,watermarkText,showWatermark,brandName,brandHandle,showBrandFooter,headlineOffset,subtextOffset,microStatOffset,const DeepCollectionEquality().hash(undoStack),const DeepCollectionEquality().hash(redoStack)]);
...
@override
int get hashCode => Object.hashAll([runtimeType,brief,cardData,isExtracting,extractionError,selectedTemplate,selectedRatio,selectedFont,headlineScale,templateCompact,activePanel,focusedField,backgroundImage,scrimOpacity,useVignette,useAutoPalette,const DeepCollectionEquality().hash(_extractedPalette),const DeepCollectionEquality().hash(_rewritingFields),rewriteError,watermarkText,showWatermark,brandName,brandHandle,showBrandFooter,headlineOffset,subtextOffset,microStatOffset,const DeepCollectionEquality().hash(_undoStack),const DeepCollectionEquality().hash(_redoStack)]);
