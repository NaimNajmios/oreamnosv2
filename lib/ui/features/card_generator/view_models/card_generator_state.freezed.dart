...
@override
int get hashCode => Object.hashAll([runtimeType,brief,cardData,isExtracting,extractionError,selectedTemplate,selectedRatio,selectedFont,headlineScale,imagePosition,photoFilter,templateCompact,activePanel,focusedField,backgroundImage,scrimOpacity,useVignette,useAutoPalette,const DeepCollectionEquality().hash(extractedPalette),const DeepCollectionEquality().hash(rewritingFields),rewriteError,watermarkText,showWatermark,brandName,brandHandle,showBrandFooter,headlineOffset,subtextOffset,microStatOffset,const DeepCollectionEquality().hash(undoStack),const DeepCollectionEquality().hash(redoStack)]);

@override
String toString() {
  return 'CardGeneratorState(brief: $brief, cardData: $cardData, isExtracting: $isExtracting, extractionError: $extractionError, selectedTemplate: $selectedTemplate, selectedRatio: $selectedRatio, selectedFont: $selectedFont, headlineScale: $headlineScale, imagePosition: $imagePosition, photoFilter: $photoFilter, templateCompact: $templateCompact, activePanel: $activePanel, focusedField: $focusedField, backgroundImage: $backgroundImage, scrimOpacity: $scrimOpacity, useVignette: $useVignette, useAutoPalette: $useAutoPalette, extractedPalette: $extractedPalette, rewritingFields: $rewritingFields, rewriteError: $rewriteError, watermarkText: $watermarkText, showWatermark: $showWatermark, brandName: $brandName, brandHandle: $brandHandle, showBrandFooter: $showBrandFooter, headlineOffset: $headlineOffset, subtextOffset: $subtextOffset, microStatOffset: $microStatOffset, undoStack: $undoStack, redoStack: $redoStack)';
}
...
@override
int get hashCode => Object.hashAll([runtimeType,brief,cardData,isExtracting,extractionError,selectedTemplate,selectedRatio,selectedFont,headlineScale,imagePosition,photoFilter,templateCompact,activePanel,focusedField,backgroundImage,scrimOpacity,useVignette,useAutoPalette,const DeepCollectionEquality().hash(_extractedPalette),const DeepCollectionEquality().hash(_rewritingFields),rewriteError,watermarkText,showWatermark,brandName,brandHandle,showBrandFooter,headlineOffset,subtextOffset,microStatOffset,const DeepCollectionEquality().hash(_undoStack),const DeepCollectionEquality().hash(_redoStack)]);
