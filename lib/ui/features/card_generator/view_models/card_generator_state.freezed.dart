...
@override
int get hashCode => Object.hashAll([runtimeType,brief,cardData,isExtracting,extractionError,selectedTemplate,selectedRatio,selectedFont,headlineScale,imagePosition,photoFilter,templateCompact,activePanel,focusedField,backgroundImage,scrimOpacity,useVignette,useAutoPalette,const DeepCollectionEquality().hash(_extractedPalette),const DeepCollectionEquality().hash(_rewritingFields),rewriteError,watermarkText,showWatermark,watermarkImage,watermarkSize,watermarkOffset,brandName,brandHandle,showBrandFooter,imageOpacity,backgroundBlurRadius,badgeText,accentColor,previewScale,backgroundType,presetBackground,textShadowRadius,textShadowColor,isGlowEnabled,headlineOffset,subtextOffset,microStatOffset,const DeepCollectionEquality().hash(_undoStack),const DeepCollectionEquality().hash(_redoStack)]);
