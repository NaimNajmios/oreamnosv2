class PromptManager {
  static String buildSystemPrompt({
    ...
    buffer.writeln(
      'Your task is to transform the provided football news or content into a highly engaging, Malaysian Malay social media post.',
    );
    ...
    if (defaultHashtags.isNotEmpty) {
      buffer.writeln(
        'Append the following hashtags at the very end of the post: $defaultHashtags',
      );
    }
