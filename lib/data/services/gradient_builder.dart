...
class GradientBuilder {
  ...
  static RadialGradient radial(List<Color> colors) {
    return RadialGradient(center: Alignment.center, radius: 1.0, colors: colors);
  }
  ...
  static LinearGradient lightScrim(double opacity) {
    return LinearGradient(
      ...
      colors: [Colors.white.withValues(alpha: opacity * 0.2), Colors.black.withValues(alpha: opacity * 0.5)],
    );
  }
  ...
  static LinearGradient minimalScrim(double opacity) {
    return LinearGradient(
      ...
      colors: [Colors.transparent, Colors.black.withValues(alpha: opacity * 0.6)],
    );
  }
  ...
  static Gradient scrimFor(ScrimType type, double opacity) {
    switch (type) {
      case ScrimType.dark: return darkScrim(opacity);
      case ScrimType.light: return lightScrim(opacity);
      case ScrimType.minimal: return minimalScrim(opacity);
      case ScrimType.none: return const LinearGradient(colors: [Colors.transparent, Colors.transparent]);
      case ScrimType.horizontal: return horizontalScrim(opacity);
      case ScrimType.reverseHorizontal: return reverseHorizontalScrim(opacity);
    }
  }
}
